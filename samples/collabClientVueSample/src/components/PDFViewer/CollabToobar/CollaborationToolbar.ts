export const collaborationToolbar = `<toolbar name="collaboration-toolbar" class="fv__ui-toolbar-scrollable fv__ui-toolbar-collaboration">
    <paddle exclude-devices="tablet" name="fv--collaboration-toolbar-paddle">
        <group-list name="collaboration-toolbar-group-list" shrink-size="1200">
            <group retain-count="2">
                <hand-ribbon-button></hand-ribbon-button>
                <selection-ribbon-dropdown></selection-ribbon-dropdown>
            </group>
            <group retain-count="1" name="collaboration-comment-tab-group-mark">
            ...
            <group retain-count="7" name="collaboration-comment-tab-group-text">
